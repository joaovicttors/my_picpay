package com.joaovicttors.user_feature.utils
 ...
 */
inline fun <reified F : Fragment> DataBindingIdlingResource.monitorFragment(fragmentScenario: FragmentScenario<F>) {
